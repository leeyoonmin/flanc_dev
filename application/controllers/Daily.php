...
class Daily extends CI_Controller {
  ...
  function __construct()
  {
	...
	{
    $this->_start_layout(array('reset','layout','dailyMain'));                          //-- 레이아웃 시작
		//--------------------------------------------------------------------------------------------------------

		$this->load->view('daily/main');

		//--------------------------------------------------------------------------------------------------------
		$this->_end_layout(array('layout','dailyMain'));                                    //-- 레이아읏 끝
	}

  public function productList()//----------------------------------------------------------------------------------------------// [오늘의꽃] 상품리스트 VIEW
	{
