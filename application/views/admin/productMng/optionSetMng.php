<div class="divContents optionSetMng">
...
<div class="divGrid is_check">
  <table>
      <tr class="head">
        <td class="checkBox">□</td><td>옵션셋ID</td><td>옵션셋명</td><td>옵션셋설명</td>
      </tr>
      <?php
        foreach($GRID_DATA as $item){
          echo "
          <tr class=\"body\">
            <td class=\"checkBox\" idxkey=\"".$item->OPTION_SET_ID."\">□</td><td>".$item->OPTION_SET_ID."</td><td>".$item->OPTION_SET_NAME."</td><td>".$item->OPTION_SET_DESC."</td>
          </tr>
          ";
        }
        if($ROW_CNT < 1){
